"""strategy cascade — objectives / KPIs / alignment / readiness gap (Phase P-J)
...
from app.models import strategy as st
...
TENANT_TABLE_OBJS = [
    st.StrategicObjective.__table__, st.StrategicKpi.__table__,
    st.ObjectiveCompetency.__table__, st.StrategicReadinessGap.__table__,
]
TENANT_TABLES = ["st_objective", "st_kpi", "st_objective_competency", "st_readiness_gap"]
